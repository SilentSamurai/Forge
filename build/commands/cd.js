...
var CdCommand = /** @class */ (function () {
    function CdCommand() {
    }

    CdCommand.prototype.process = function (context, step) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!utility_1.Utility.pathExists(step.path)) {
                            throw Error(step.path + " not found.");
                        }
                        return [4 /*yield*/, process.chdir(step.path)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
